...
O método validate implementa as regras de validação para o dominio. Os valores são validados por meio do algoritmo de \hyperlink{classshibarides_1_1CPF}{C\+PF}, que pode ser encontrado \href{https://www.geradorcpf.com/algoritmo_do_cpf.htm}{\tt aqui}
