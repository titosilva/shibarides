    ...
    while(true){
        ...
        switch((int)getch()){
            ...
            case ENTER:
                switch(sel){
                    case 0:
                        return InitMainUI::INIT_MAIN_LOGIN;
                        break;
                    case 1:
                        return InitMainUI::INIT_MAIN_SIGNUP;
                        break;
                    case 3:
                        return InitMainUI::INIT_MAIN_EXIT;
                        break;
                    case 2:
                        return InitMainUI::INIT_MAIN_LIST;
                        break;
                }
        }
    }
